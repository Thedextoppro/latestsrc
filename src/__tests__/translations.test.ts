...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master DEX chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of DEX.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's DEX)`,
