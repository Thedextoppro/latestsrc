...
const processViewLotterySuccessResponse = (response, lotteryId: string): LotteryResponse => {
  ...
  const serializedxfnPerBracket = xfnPerBracket.map((cakeInBracket) => ethersToSerializedBigNumber(cakeInBracket))
  ...
  return {
    ...
    priceTicketInXfn: ethersToSerializedBigNumber(priceTicketInXfn),
    discountDivisor: discountDivisor?.toString(),
    treasuryFee: treasuryFee?.toString(),
    firstTicketId: firstTicketId?.toString(),
    lastTicketId: lastTicketId?.toString(),
    amountCollectedInXfn: ethersToSerializedBigNumber(amountCollectedInXfn),
    finalNumber,
    xfnPerBracket: serializedxfnPerBracket,
