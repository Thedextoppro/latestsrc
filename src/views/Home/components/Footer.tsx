  ...
  return (
    <>
      ...
      >
        ...
        >
          <BunnyWrapper>
            <Image src={bunnyImage1} priority placeholder="blur" alt={t('Lunar bunny')} />
            <Image src={bunnyImage2} priority placeholder="blur" alt={t('Lunar bunny')} />
            <Image src={bunnyImage3} priority placeholder="blur" alt={t('Lunar bunny')} />
          </BunnyWrapper>
        </Flex>
